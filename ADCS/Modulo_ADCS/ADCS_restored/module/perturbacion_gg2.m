function varargout = perturbacion_gg2(varargin)
% PERTURBACION_GG2 MATLAB code for perturbacion_gg2.fig
%      PERTURBACION_GG2, by itself, creates theta new PERTURBACION_GG2 or raises the existing
%      singleton*.
%
%      H = PERTURBACION_GG2 returns the handle to theta new PERTURBACION_GG2 or the handle to
%      the existing singleton*.
%
%      PERTURBACION_GG2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PERTURBACION_GG2.M with the given input arguments.
%
%      PERTURBACION_GG2('Property','Value',...) creates theta new PERTURBACION_GG2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before perturbacion_gg2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to perturbacion_gg2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help perturbacion_gg2

% Last Modified by GUIDE v2.5 04-Mar-2014 13:36:55

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @perturbacion_gg2_OpeningFcn, ...
                   'gui_OutputFcn',  @perturbacion_gg2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before perturbacion_gg2 is made visible.
function perturbacion_gg2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in theta future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to perturbacion_gg2 (see VARARGIN)

% Choose default command line output for perturbacion_gg2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes perturbacion_gg2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = perturbacion_gg2_OutputFcn(hObject, eventdata, handles) 
